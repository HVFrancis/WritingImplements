...
class Chalk extends WritingImplement
{
    ...
    /**
     * This method simulates the chalk erasing something
     *
     * @param   words   The words the chalk erased
     */
    public void erase(String words)
    {
        System.out.println("The " + " " + getBodyMaterial() + " chalk just erased the words: " + words);
    }
}
